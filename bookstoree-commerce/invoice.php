...
if (isset($_GET['order_id'])) {
  ...
  var_dump($fetch_order['cashier_account']); // Debugging statement

  $get_order_details = mysqli_query($conn, "SELECT * FROM `orders` WHERE id = '$order_id'") or die('query failed');
  $fetch_details = mysqli_fetch_assoc($get_order_details);
$fetch_details = mysqli_fetch_assoc($get_order_details);}
  ...
  <body>
    <div class="invoice">
          <div class="section-top">
            <div class="logo">
                <a><span>ONLINE BOOK STORE E-COMMERCE SYSTEM FOR ASSOSA TOWN</span>
                    </a>
            </div>
        ...
        <tr>
          ...
          <div class="buyer-details">
              <p class="buyer-name">BY,  ONLINE BOOK STORE E-COMMERCE SYSTEM FOR ASSOSA TOWN</p>
          ...
          <th class="details"><div class="section-mid-one"><h3>Details:</h3>
            <div class="buyer-details">
                ...
                <p class="buyer-STATE">cashier_account: '.$fetch_order['cashier_account'].' </p>
                <p class="buyer-STATE">account_paid: '.$fetch_order['account_paid'].' </p>
            </div>
        </div></th>
        </tr>
      </table>
...
">
      ...
      <hr />
      <div>
        <div class="sign">ONLINE BOOK STORE E-COMMERCE</div>
      </div>
    </div>
  </body>
</html>';
