...
include 'config.php';
session_start();
$accountant_id = $_SESSION['accountant_id']; // Correct variable name
$accountant_name = $_SESSION['accountant_name']; // Correct variable name
...
if (isset($_POST['send_msg'])) {
    ...
    mysqli_query($conn, "INSERT INTO msg (`user_id`,`name`,`email`, `number`, `msg`) VALUES('$accountant_id','$name','$email','$phone','$msg')") or die('Mesage send Query failed');
...
<div class="contact-section" >
    ...
    <h1>Contact Us</h1>
    <h3>Hello, <span><?php echo $accountant_name; ?></span> &nbsp;how we can help you?</h3>
