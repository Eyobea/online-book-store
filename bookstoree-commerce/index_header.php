...
<body>
  <header>
    ...
    <?php if(isset($_SESSION['user_name'])){echo' <img style="height:60px; margin-left:20px ;" src="images/yone.jpg" class="user-pic" onclick="toggleMenu()" />';}
    else{
...
<div class="sub-menu-wrap" id="subMenu">
  <div class="sub-menu">
    ...
    <a href="updateuseraccount.php" class="sub-menu-link">
      <p>updateuseraccount</p>
      <span>></span>
    </a>
    <a href="user_balance_display.php" class="sub-menu-link">
      <p>user balance</p>
      <span>></span>
    </a>
