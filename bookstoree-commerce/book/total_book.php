...
include 'config.php';
session_start();
$admin_id = $_SESSION['accountant_id'];
  ...
  <section class="show-products">
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="price">Price: birr <?php echo $fetch_book['price']; ?></div>
         <a href="total_book.php?update=<?php echo $fetch_book['bid']; ?>" class="update_btn">update</a>
         <a href="total_book.php?delete=<?php echo $fetch_book['bid']; ?>" class="delete_btn" onclick="return confirm('delete this product?');">delete</a>
      </div>
      <?php
         }
      }else{
