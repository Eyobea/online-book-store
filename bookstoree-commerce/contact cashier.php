<?php
    ...
    if(isset($_POST['send_msg'])) {
      ...
      $phone = mysqli_real_escape_string($conn, $_POST['phone']);
          ...
          mysqli_query($conn, "INSERT INTO msg (`cashier_id`,`name`,`email`, `number`, `msg`) VALUES('$user_id','$name','$email','$phone','$msg')") or die('Mesage send Query failed');
...
<body>
  ...
  <div class="contact-section" >
    ...
    <h1>Contact Us</h1>
    <h3>Hello, <span><?php echo $cashier_name;?> </span> &nbsp;how we can help you?</h3>
